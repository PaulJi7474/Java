...
public class WinGameView extends View {
    ...
    private final GameModel game; // game state we use to access relevant data to display
    private final GameController controller;
    /**
     * controller state
     * we use to bind relevant method calls if any
     */
    private final JTextArea winText; // main win text area
    private final JTextArea details; // details text area

    /**
     * Constructs a new {@link WinGameView} using access to the given game state and
     * controller state
