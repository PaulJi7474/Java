...
/**
 * Enum for the colour pallete used throughout this project, intended to help
 * remove magic
 * hexcodes littering the codebase.
 *
 * <p>
 * sample use
 * {@code Pallete.RED.color(); to get the red {@link java.awt.Color} value based
 * on the color value
 * stored inside the pallete.}
 */
public enum Pallete {
    // Define all the colours used in the pallete
    GREYDARK("#595e5c"),
    GREY("#869393"),
    WHITEMID("#efece8"),
    WHITE("#f9f9f7"),
    ...
    private final String hex; // Stringified hex code for the relevant Pallete option
