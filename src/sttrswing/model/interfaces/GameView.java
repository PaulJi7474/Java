...
/**
 * This is for specifying what methods are required specifically for use by the
 * View, not every
 * method in our {@link Game} that needs to be public for testing, needs to be
 * exposed to our View.
 */
public interface GameView {
    ...
    /**
     * Get the current X,Y coordinates for the current
     * {@link sttrswing.model.Quadrant}
     */
     ...
     *
     * @param requestedEnergyToSpend the amount of energy to adjust the players
     *                               shields by.
     */
