...
/**
 * A {@link LoseGameView} that shows the mission loss screen to the user,
 * including an image loaded
 * with {@link ImageLoader}.
 */
public class LoseGameView extends View {

    private final GameModel game; // game state we use to access relevant data
    private final GameController controller; // controller state we use to bind relevant
                                             // method calls to our listeners
    private final JTextArea loseText; // text area for displaying lose message
    private final JTextArea details; // text area for displaying lose details
     ...
     * to access relevant data and bind relevant method calls from both states to
     * our listeners.
     *
    ...
    /**
     * Public for testability reasons. Constructs a {@link JTextArea} configured for
     * our
     * {@link WinGameView}. editable: false lineWrap: true wrapStyleWord: true
     * foreground: white from
