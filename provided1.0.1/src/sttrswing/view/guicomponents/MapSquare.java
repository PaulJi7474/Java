...
public class MapSquare extends JLabel {
    ...
    /**
     * Creates a {@link MapSquare} with a given symbol to display and {@link Color}s
     * for the
    ...
    /**
     * Creates a {@link MapSquare} with a default background {@link Color} from
     * {@link Pallete}, a
     * given symbol to display and a customisable foreground and border
     * {@link Color}.
     *
     * @param symbol         - symbol we want to display on the square.
     * @param highlightColor - colour we want to use for the border and foreground
     *                       of this square.
     */
    public MapSquare(
            final String symbol,
    ...
    /**
     * Creates a {@link MapSquare} with a default background,foreground and border
     * {@link Color} from
     * {@link Pallete}
     *
     * @param symbol - symbol we want to display on the square.
