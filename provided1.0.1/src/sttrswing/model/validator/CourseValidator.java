...
/**
 * {@link Validator} overwrites isValid to validate that the given course input
 * is 1 or more
...
public class CourseValidator extends Validator {
    ...
    /**
     * Takes the given {@link String} input and return if the given String input can
     * be evaluated as 1
     * or more (inclusive) and less than 9.
     *
     * @param input - The given {@link String} we wish to evaluate.
     * @return if the given String input can be evaluated as 1 or more (inclusive)
     *         and less than 9.
     */
    @Override
    public boolean isValid(final String input) {
        var trimmedInput = input.trim().toUpperCase(); // trim whitespace and uppercase
